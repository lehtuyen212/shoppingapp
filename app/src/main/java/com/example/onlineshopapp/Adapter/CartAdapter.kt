...
class CartAdapter(
    private val listItemSelected: ArrayList<ItemsModel>, context: Context, var changeNumberItemsListener: ChangeNumberItemsListener?=null
    ...
    override fun onBindViewHolder(holder: CartAdapter.ViewHolder, position: Int) {
        ...
        holder.binding.totalEahItem.text="$${Math.round(item.numberInCart * item.price)}"
